...
function calculateTotal(){
    ...
    .forEach(function(box){
        let card = box.closest(".shop-card");
    ...
    priceTotal.innerHTML = "KR " + total.toFixed(2);
    grandTotal.innerHTML = "KR " + total.toFixed(2);
}
...
.forEach(function(btn){
    btn.addEventListener("click", function(e){
        ...
        // Check button text content or structure for plus/minus actions
